...
class CatRelatedAllProductShow extends StatefulWidget {
  final String imgUrl;
  CatRelatedAllProductShow({this.imgUrl});
  @override
  _CatRelatedAllProductShowState createState() =>
      _CatRelatedAllProductShowState();
}

class _CatRelatedAllProductShowState extends State<CatRelatedAllProductShow> {
  @override
  void initState() {
    super.initState();
          ...
          SliverAppBar(
            ...
            title: Container(
                ...
                child: Padding(
                  ...
                  child: Text(Get.parameters['cat_name'],
